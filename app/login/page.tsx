    ...
    <div className="min-h-screen bg-[#121212] flex items-center justify-center p-4">
      <div className="bg-[#1A1A1A] border border-white/10 p-8 rounded-2xl shadow-2xl w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-400">مرحباً بك مجدداً في بورصة المونديال</p>
        </div>
        ...
        <form onSubmit={handleLogin} className="space-y-4">
          ...
          <div className="text-left mt-2">
            <Link href="/forgot-password" className="text-[#0FF0FC] text-sm hover:underline">نسيت كلمة المرور؟</Link>
          </div>

          <button type="submit" className="w-full bg-[#0FF0FC] text-black font-bold py-3 rounded-lg hover:bg-[#0FF0FC]/80 transition-colors mt-4">
            دخول
          </button>
        </form>
        ...
        <p className="text-gray-500 text-center mt-6 text-sm">
          ليس لديك حساب؟ <Link href="/register" className="text-[#0FF0FC] hover:underline">إنشاء حساب جديد</Link>
        </p>
      </div>
    </div>
  );
