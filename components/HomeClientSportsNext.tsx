    ...
    <main className="mx-auto max-w-7xl px-4 py-10 text-white sm:px-6 lg:px-8">
      <section className="rounded-[2rem] border border-white/10 bg-white/[0.04] p-6 shadow-[0_20px_70px_rgba(0,0,0,0.35)] lg:p-10">
        ...
        <p className="mt-5 max-w-3xl text-base leading-8 text-gray-300 md:text-lg">
          مباريات، أخبار، مجموعات، وتحليل فني في تجربة واحدة. تم إيقاف محتوى المنتخبات واللاعبين والصفحات المرتبطة بالتداول أو البورصة الافتراضية من الواجهة العامة.
        </p>
        <div className="mt-8 flex flex-wrap gap-3">
          ...
          <Link href="/news" className="rounded-2xl border border-white/10 bg-white/10 px-6 py-3 text-sm font-black text-white transition hover:bg-white/15">
            الأخبار
          </Link>
        </div>
      </section>
