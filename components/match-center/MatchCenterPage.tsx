        ...
        <section id="live-broadcast" className="rounded-[1.45rem] border border-white/10 bg-white/[0.035] p-3 shadow-card sm:rounded-[1.5rem] sm:p-5">
          <div className="mb-4 flex flex-wrap items-center justify-between gap-3">
            ...
            <div className="flex flex-wrap items-center gap-2">
              <Link href={`/animation-live/player-v2?dbMatchId=${encodeURIComponent(match.id)}`} className="inline-flex min-h-10 items-center gap-2 rounded-xl border border-[#FFD700]/25 bg-[#FFD700]/10 px-3 text-sm font-black text-[#FFF7CC] transition hover:border-[#FFD700]/45 hover:bg-[#FFD700]/15 hover:text-white">
                جرّب V2
              </Link>
