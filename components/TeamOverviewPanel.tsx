...
function Profile({ team, reports }: { team: Team; reports: Report[] }) {
  ...
  const structuredData = getRealWorldCupData(team.name);
  ...
  <TeamWorldCupHistory teamName={team.name} historyText={history} structuredData={!history && structuredData ? structuredData : undefined} />
