    ...
    items: [
      {
        ...
        title: 'حالة النظام',
        icon: HeartPulse,
        what: 'يفحص اتصال قاعدة البيانات، زمن استجابة السيرفر، بيئة التشغيل، حالة التشغيل المجدول، وعدد الأصول والمنتخبات واللاعبين والمباريات.',
        when: 'بعد كل Deploy، أو عند ظهور صفحة لا تعرض بيانات، أو عند الشك أن قاعدة البيانات لا تتصل بشكل صحيح.',
      },
      {
        href: '/admin/live-health',
        title: 'صحة التحديث المباشر',
        icon: Gauge,
        what: 'يراقب حالة المباريات الحية، المباريات غير المرتبطة، توصيات التشغيل، وحالة التحديث التلقائي أثناء المباريات.',
        when: 'قبل وأثناء المباريات للتأكد أن النتائج والعدادات وشريط المباريات يتم تحديثهم.',
      },
      {
        href: '/admin/apis',
        title: 'اختبارات APIs',
        icon: Activity,
        what: 'لوحة لاختبار مزودي البيانات، عرض نتائج مباشرة، فحص بيانات اللاعبين، وتجربة عمليات تنظيف أو مزامنة آمنة.',
        when: 'عند تجربة مصدر بيانات جديد أو عند وجود اختلاف بين ما يظهر في الموقع وما تتوقعه من المزود.',
      },
      {
        href: '/admin/data-verification',
        title: 'تحقق البيانات',
        icon: ClipboardCheck,
        what: 'يقارن بيانات موقعك المحلية ببيانات المزودين ويعرض المتطابق والمختلف والمفقود.',
        when: 'قبل نشر أرقام حساسة مثل النتيجة، الترتيب، الإحصائيات، أو بيانات TheStats.',
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        title: 'بناء بيانات كأس العالم',
        icon: Database,
        what: 'يجلب المنتخبات واللاعبين والصور والمباريات والمجموعات ويعيد بناء قاعدة بيانات البطولة.',
        when: 'في بداية البطولة، أو عند نقص منتخبات/لاعبين/مباريات، أو عند الحاجة لمزامنة كاملة.',
      },
      {
        href: '/admin/animation-matches',
        title: 'ربط مباريات الأنيميشن',
        icon: Wand2,
        what: 'يعرض مباريات الموقع ويقترح رقم المباراة الخارجي المناسب ثم يسمح بحفظه على المباراة المحلية.',
        when: 'عندما لا تظهر بيانات البث التفاعلي أو ملعب المباراة بسبب عدم وجود رقم ربط خارجي.',
      },
      {
        href: '/admin/unlinked-matches',
        title: 'المباريات غير المرتبطة',
        icon: Link2,
        what: 'يعرض المباريات التي لا تملك ربطًا خارجيًا داخل نافذة زمنية، مع إمكانية إدخال بيانات الربط يدويًا.',
        when: 'قبل بداية كل يوم مباريات للتأكد أن كل مباراة قادمة أو مباشرة مربوطة بمصدرها.',
      },
      {
        href: '/admin/isports-candidates',
        title: 'مرشحو iSports',
        icon: FileSearch,
        what: 'يبحث عن المرشحين المناسبين لمباراة محلية ويعرض درجة الثقة وأسباب التطابق.',
        when: 'بعد فتح مباراة غير مرتبطة لاختيار أفضل fixture من iSports وربطه بالمباراة المحلية.',
      },
      {
        href: '/admin/isports',
        title: 'لوحة iSports',
        icon: Radio,
        what: 'اختبار نتائج iSports المباشرة، التشكيلات، اللاعبين، والمعلومات القادمة من المزود.',
        when: 'للتشخيص والتجربة قبل اعتماد بيانات iSports في صفحة المباراة أو الشريط.',
      },
      {
        href: '/admin/thesportsdb',
        title: 'TheSportsDB',
        icon: Globe2,
        what: 'فحص مزود TheSportsDB كمصدر مساعد للفرق أو المباريات أو المعلومات العامة.',
        when: 'عند نقص بيانات من المصدر الأساسي وتحتاج مقارنة أو مصدر داعم.',
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        title: 'تقارير المنتخبات',
        icon: FileText,
        what: 'إنشاء ومراجعة تقارير Team Intelligence الخاصة بكل منتخب وربطها بمركز التحليل.',
        when: 'قبل كتابة تحليل منتخب أو تجهيز سكربت فيديو تكتيكي.',
      },
      {
        href: '/admin/source-automation',
        title: 'أتمتة المصادر',
        icon: Bot,
        what: 'فحص استقبال المصادر، ملفات CSV، التقارير التلقائية، وسجلات تشغيل الأتمتة.',
        when: 'عند رفع مصادر جديدة أو تشغيل إدخال تلقائي يحتاج مراجعة لاحقة.',
      },
      {
        href: '/admin/source-review',
        title: 'مراجعة المصادر',
        icon: ShieldAlert,
        what: 'يعرض المصادر والتقارير التي دخلت تلقائيًا وتحتاج قبولًا أو رفضًا قبل الاعتماد عليها.',
        when: 'قبل نشر أي معلومة تحليلية. إذا لم تجد الرقم صريحًا، اتركه غير متوفر في المصادر.',
      },
      {
        href: '/admin/match-media',
        title: 'مصادر فيديو المباريات',
        icon: PlayCircle,
        what: 'إضافة روابط الملخصات، الأهداف، والمؤتمرات الصحفية من مصادر رسمية أو قابلة للمراجعة.',
        when: 'عند ربط مقال أو صفحة مباراة بفيديو رسمي بدون رفع الفيديو نفسه.',
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        title: 'إدارة الأخبار',
        icon: Newspaper,
        what: 'تحويل النشرات والإيميلات إلى خبر، منشور فيسبوك، سكربت فيديو، ونقاط إنفوجرافيك.',
        when: 'عند إنتاج خبر سريع أو تحويل مصدر صحفي إلى محتوى جاهز للنشر.',
      },
      {
        href: '/admin/content-studio',
        title: 'استوديو المحتوى',
        icon: FileText,
        what: 'مراجعة وتعديل وحذف الأخبار وملخصات اليوم وملخصات المباريات المحفوظة.',
        when: 'كأرشيف تحريري شامل لتنظيف المحتوى أو فتح منشورات سابقة.',
      },
      {
        href: '/admin/match-events',
        title: 'أحداث المباراة',
        icon: Trophy,
        what: 'إضافة أهداف، بطاقات، تبديلات، وملاحظات تظهر في Timeline داخل مركز المباراة.',
        when: 'عند نقص أحداث المزود أو عند الحاجة لإدخال حدث يدوي موثق.',
      },
      {
        href: '/daily-summary',
        title: 'ملخص اليوم',
        icon: Sparkles,
        what: 'عرض نتائج ورصد اليوم وسكربت سريع قابل للنشر.',
        when: 'نهاية اليوم أو قبل صناعة فيديو/منشور ملخص سريع.',
      },
    ],
  },
  {
    ...
    items: [
      {
        href: '/portfolio',
        title: 'المحفظة والسوق',
        icon: BarChart3,
        what: 'مراجعة شكل المحفظة والأسعار بعد تحديث السوق الافتراضي.',
        when: 'للتأكد أن بيانات السوق لا تكسر تجربة المستخدم أو شكل الواجهة.',
      },
    ],
  },
];
