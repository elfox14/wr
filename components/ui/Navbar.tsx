            ...
            <div className="flex items-center gap-3">
              {status === 'loading' ? (
                  ...
                  <div className="relative" ref={dropdownRef}>
                    ...
                    <div className={`absolute left-0 top-full mt-2 w-56 bg-[#121212] border border-white/10 rounded-2xl shadow-2xl backdrop-blur-xl overflow-hidden transition-all duration-200 transform origin-top-left ${isDropdownOpen ? 'opacity-100 scale-100 visible' : 'opacity-0 scale-95 invisible'}`}>
                      ...
                      <div className="p-2 space-y-1">
                        ...
                        <Link href="/market?type=TEAM" className="flex items-center gap-3 px-3 py-2.5 text-sm text-gray-300 hover:text-white hover:bg-white/5 rounded-xl transition-colors">
                          <Shield size={16} /> المنتخبات
                        </Link>
                ...
                <div className="hidden lg:flex items-center gap-3">
                  <Link href="/login" className="px-4 py-2 text-sm font-bold text-gray-300 hover:text-white transition-colors">
                    تسجيل الدخول
                  </Link>
                  <Link href="/register" className="bg-[#0FF0FC] hover:bg-[#0FF0FC]/80 text-black px-6 py-2 rounded-full font-black text-sm shadow-[0_0_15px_rgba(15,240,252,0.3)] hover:shadow-[0_0_20px_rgba(15,240,252,0.5)] transition-all">
                    إنشاء حساب
                  </Link>
                </div>
              )}
