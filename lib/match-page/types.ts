...
export type MatchHistoryContext = { homeRecentForm: MatchFormItem[]; awayRecentForm: MatchFormItem[]; headToHead: HeadToHeadItem[]; homeWorldCupHistory?: string | null; awayWorldCupHistory?: string | null; homeWorldCupHistoryUrl?: string | null; awayWorldCupHistoryUrl?: string | null; };
